            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h1
                    className={`text-sm sm:text-lg lg:text-2xl font-bold text-white truncate ${
                      currentLanguage === "ne" ? "nepali" : ""
                    }`}
                  >
                    {t("city_name")}
                  </h1>
                  <p className="text-xs sm:text-sm text-white hidden sm:block truncate">
              ...
              <nav className="hidden lg:flex items-center gap-1">
                ...
                {user ? (
                  <div className="flex items-center gap-2 xl:gap-3">
                    <span className="flex items-center gap-2 text-xs xl:text-sm text-white truncate max-w-39 xl:max-w-38">
                      <img
                        src={userpic}
                        alt=""
                    ...
                    <button
                      onClick={logout}
                      className="municipal-button text-xs xl:text-sm px-3 py-2 bg-white/20 hover:bg-white/30 transition-colors"
                    >
                      {t("logout")}
                    </button>
                  </div>
              ...
              <nav className="container mx-auto px-4 py-6 max-h-screen overflow-y-auto">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="border-t border-white/20 pt-4 mt-2">
                    <div className="text-white font-semibold mb-3 px-4 text-sm sm:text-base">
                      {t("services")}
                    </div>
                  ...
                  {user ? (
                    <div className="flex flex-col gap-3 border-t border-white/20 pt-4 mt-2">
                      <span className="text-xs sm:text-sm text-white px-4">
                        Welcome, {user.name}
                      </span>
                      <button
                        onClick={() => {
